...
export const translations = {
  ru: {
    ...
    // — быстрая разблокировка: установка PIN —
    pinSetupTitle: 'Установите PIN-код для быстрого входа',
    pinSetupPrompt: '4 цифры. Понадобится, чтобы быстро открывать приложение.',
    pinSetupRepeatPrompt: 'Повторите PIN-код ещё раз.',
    pinSetupMismatch: 'PIN-коды не совпадают. Попробуйте снова.',
    pinContinue: 'Продолжить',
    pinSaving: 'Сохранение...',
    // — предложение включить биометрию —
    biometryTitle: 'Включить Face ID / отпечаток?',
    biometryPrompt: 'Открывайте приложение одним касанием — без ввода PIN-кода.',
    biometryEnable: 'Включить',
    biometryEnabling: 'Подключение...',
    biometrySkip: 'Пропустить',
    biometryFailed: 'Не удалось подключить биометрию. Можно попробовать позже в настройках.',
    // — экран блокировки —
    ...
    profilePinCurrent: 'Текущий PIN',
    profilePinNew: 'Новый PIN',
    profilePinRepeat: 'Повторите новый PIN',
    profilePinChanged: 'PIN-код изменён ✅',
    profilePinWrong: 'Неверный текущий PIN',
    profileBiometryLabel: 'Face ID / отпечаток',
    profileBiometryOn: 'Включена',
    profileBiometryOff: 'Выключена',
    profileBiometryEnable: 'Включить',
    profileBiometryDisable: 'Отключить',
  },
  ...
  uz: {
    ...
    // — tez kirish: PIN o‘rnatish —
    pinSetupTitle: 'Tez kirish uchun PIN-kod o‘rnating',
    pinSetupPrompt: '4 ta raqam. Ilovani tez ochish uchun kerak bo‘ladi.',
    pinSetupRepeatPrompt: 'PIN-kodni yana bir marta takrorlang.',
    pinSetupMismatch: 'PIN-kodlar mos kelmadi. Qaytadan urinib ko‘ring.',
    pinContinue: 'Davom etish',
    pinSaving: 'Saqlanmoqda...',
    // — biometriyani yoqish taklifi —
    biometryTitle: 'Face ID / barmoq izini yoqasizmi?',
    biometryPrompt: 'Ilovani bir teginish bilan oching — PIN-kodsiz.',
    biometryEnable: 'Yoqish',
    biometryEnabling: 'Ulanmoqda...',
    biometrySkip: 'O‘tkazib yuborish',
    biometryFailed: 'Biometriyani ulab bo‘lmadi. Keyinroq sozlamalarda urinib ko‘ring.',
    // — bloklash ekrani —
    lockTitle: 'PIN-kodni kiriting',
    lockWrongPin: 'PIN-kod noto‘g‘ri',
    ...
    profilePinCurrent: 'Joriy PIN',
    profilePinNew: 'Yangi PIN',
    profilePinRepeat: 'Yangi PINni takrorlang',
    profilePinChanged: 'PIN-kod o‘zgartirildi ✅',
    profilePinWrong: 'Joriy PIN noto‘g‘ri',
    profileBiometryLabel: 'Face ID / barmoq izi',
    profileBiometryOn: 'Yoqilgan',
    profileBiometryOff: 'O‘chirilgan',
    profileBiometryEnable: 'Yoqish',
    profileBiometryDisable: 'O‘chirish',
  },
  ...
  en: {
    ...
    // — quick unlock: set PIN —
    pinSetupTitle: 'Set a PIN for quick access',
    pinSetupPrompt: '4 digits. You’ll use it to open the app quickly.',
    pinSetupRepeatPrompt: 'Enter the PIN once more.',
    pinSetupMismatch: 'PINs don’t match. Try again.',
    pinContinue: 'Continue',
    pinSaving: 'Saving...',
    // — offer to enable biometrics —
    biometryTitle: 'Enable Face ID / fingerprint?',
    biometryPrompt: 'Open the app with one touch — no PIN needed.',
    biometryEnable: 'Enable',
    biometryEnabling: 'Connecting...',
    biometrySkip: 'Skip',
    biometryFailed: 'Couldn’t enable biometrics. You can try later in settings.',
    // — lock screen —
    ...
    profilePinNew: 'New PIN',
    profilePinRepeat: 'Repeat new PIN',
    profilePinChanged: 'PIN changed ✅',
    profilePinWrong: 'Wrong current PIN',
    profileBiometryLabel: 'Face ID / fingerprint',
    profileBiometryOn: 'On',
    profileBiometryOff: 'Off',
    profileBiometryEnable: 'Enable',
    profileBiometryDisable: 'Disable',
  },
} as const;
